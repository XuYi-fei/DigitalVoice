...
def wiener_subproc_process(data_to_process, data_fs):
    ...
    AudioUtils.write_data(output_data, data_fs, "wiener_subproc_filtered_data.wav")
...
def wiener_process(pure_noise, data_to_process, clean_data, data_fs):
    ...
    filtered_data *= 5
    AudioUtils.write_data(filtered_data, data_fs, "wiener_filtered_data.wav")
...
if __name__ == "__main__":
    ...
    # 原始维纳滤波处理
    wiener_process(noise_data, noisy_data, data, data_fs=fs)
